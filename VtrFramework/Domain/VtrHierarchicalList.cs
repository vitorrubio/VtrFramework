...
namespace VtrFramework.Domain
{
    ...
    /// </summary>
    public class VtrHierarchicalList : List<VtrHierarchicalParameter>, IHierarchicalEnumerable
    {
        ...
        public VtrHierarchicalList(IEnumerable<VtrHierarchicalParameter> collection, string sep = "/")
            : base(collection)
        {
            this._separator = sep;
        }
        ...
        /// </summary>
        public VtrHierarchicalList(string sep = "/")
            : base()
        {
            this._separator = sep;
        }
        ...
        public VtrHierarchicalList(int capacity, string sep = "/")
            : base(capacity)
        {
            this._separator = sep;
        }
        ...
        public new void Add(VtrHierarchicalParameter item)
        {
            base.Add(item);
            item.SetLista(this);
        }
        ...
        /// </summary>
        /// <param name="collection"></param>
        public new void AddRange(IEnumerable<VtrHierarchicalParameter> collection)
        {
        ...
        public virtual VtrHierarchicalParameter Add(int id, int? pai, string valor, bool ativo = true)
        {
            VtrHierarchicalParameter p = new VtrHierarchicalParameter(this, id, pai, valor, ativo);
            this.Add(p);
            return p;
        }
        ...
        public VtrHierarchicalList GetRoot()
        {
            return new VtrHierarchicalList( this.Where(x => x.IdPai == 0 || x.IdPai == null));
        }
