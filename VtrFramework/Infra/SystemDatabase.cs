...
namespace VtrFramework.Infra
{
    ...
    /// </summary> 
    public class SystemDatabase : BaseSystemDatabase, ISystemDatabase
    {

        #region propriedades privadas

        private IConnectionStringProvider _connectionStringProvider;
        private IDatabaseRequest _dabaseRequest;
        ...
        public SystemDatabase(IConnectionStringProvider connStrProvider)
        {
        ...
        public override DataSet ExecuteProcedureGetDataset(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteProcedureGetDataset(comando, parametros);
        }

        public override DataTable ExecuteProcedureGetDataTable(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteProcedureGetDataTable(comando, parametros);

        }
        public override List<DataRow> ExecuteProcedureGetEnumerable(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteProcedureGetEnumerable(comando, parametros);
        }

        public override DataSet ExecuteQueryGetDataset(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteQueryGetDataset(comando, parametros);

        }

        public override DataTable ExecuteQueryGetDataTable(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteQueryGetDataTable(comando, parametros);
        }

        public override List<DataRow> ExecuteQueryGetEnumerable(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ExecuteQueryGetEnumerable(comando, parametros);
        }

        public override List<DataRow> Procedure(string proc, params Parametro[] parametros)
        {

            return this._dabaseRequest.Procedure(proc, parametros);
        }

        public override List<T> Procedure<T>(string comando, params Parametro[] parametros) /*where T : class, new()*/
        {
            return this._dabaseRequest.Procedure<T>(comando, parametros);
        }

        public override int? ProcedureNonQuery(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.ProcedureNonQuery(comando, parametros);
        }

        public override List<DataRow> Query(string comando, params Parametro[] parametros)
        {
            return this._dabaseRequest.Query(comando, parametros);
        }

        public override List<T> Query<T>(string comando, params Parametro[] parametros) /*where T : class, new()*/
        {
            return this._dabaseRequest.Query<T>(comando, parametros);

        }

        public override int? SqlNonQuery(string comando, params Parametro[] parametros)
        {
