...
namespace VtrFramework.Test.Infra
{
    ...
    public class ParametroTest
    {
        ...
        {
            var p1 = new Parametro("@parametro", 1);
        ...
        public void CreateByteArrayTest()
        {
            ...
            var p1 = new Parametro("@parametro", v1); //se for nulo, a conversão automática não acontece, deve ser setado o tipo manualmente
            var p2 = new Parametro("@parametro", v2);
            var p3 = new Parametro("@parametro", v3);
