    ...
    public class VtrConversionTest
    {
        ...
        public class TestesConversaoBoolStringNovo 
        {
            ...
            public void NULL_BoolToStringTest()
            {
                ...
                CultureInfo culture = VtrConvert.DEFAULT_CULTURE_INFO;
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(flag, culture);
            ...
            public void BoolToStringTest1_NULL()
            {
                ...
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(flag);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest2_NULL()
            {
                ...
                string actual;
                actual = VtrConvert.ToString(flag, "nulo", "s", "n");
                Assert.AreEqual(expected, actual);
            }
        ...
        public class TesteConversaoBoolStringNovoComConstantes 
        {
            ...
            public void BoolToStringTest_TRUE()
            {
                ...
                string expected = "True";
                string actual;
                actual = VtrConvert.ToString(true, culture);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest1_TRUE()
            {
                string expected = "True";
                string actual;
                actual = VtrConvert.ToString(true);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest2_TRUE()
            {
                string expected = "s";
                string actual;
                actual = VtrConvert.ToString(true, "nulo", "s", "n");
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest_FALSE()
            {
                ...
                string expected = "False";
                string actual;
                actual = VtrConvert.ToString(false, culture);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest1_FALSE()
            {
                string expected = "False";
                string actual;
                actual = VtrConvert.ToString(false);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BoolToStringTest2_FALSE()
            {
                string expected = "n";
                string actual;
                actual = VtrConvert.ToString(false, "nulo", "s", "n");
                Assert.AreEqual(expected, actual);
            }
        ...
        public class TesteConversaoDateTimeStringNovo 
        {
            ...
            public void DateTimeToStringTest_NULL()
            {
                ...
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(data);
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                Nullable<DateTime> data = new Nullable<DateTime>();
                string format = VtrConvert.DEFAULT_DATETIME_FORMAT;
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(data, format);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void DateTimeToStringTest2_NULL()
            {
                Nullable<DateTime> data = new Nullable<DateTime>();
                string format = VtrConvert.DEFAULT_DATETIME_FORMAT;
                IFormatProvider culture = VtrConvert.DEFAULT_CULTURE_INFO;
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(data, format, culture);
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                Nullable<DateTime> data = new Nullable<DateTime>(new DateTime(1983, 2, 14, 13, 55, 59));
                string format = VtrConvert.DEFAULT_DATE_FORMAT;
            ...
            public void DateTimeToStringTest1_3()
            {
                ...
                string actual;
                actual = VtrConvert.ToString(data, format, CultureInfo.InvariantCulture);
                Assert.AreEqual(expected, actual);
            }
        ...
        public class TesteConversaoDoubleStringNovo 
        {
            ...
            public void DoubleToStringTest_NULL()
            {
                ...
                string format = VtrConvert.DEFAULT_FLOAT_FORMAT;
                IFormatProvider culture = VtrConvert.DEFAULT_CULTURE_INFO;
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(numero, format, culture);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void DoubleToStringTest1_NULL()
            {
                ...
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(numero);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void DoubleToStringTest2_NULL()
            {
                ...
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(numero, format);
                Assert.AreEqual(expected, actual);
            }
        ...
        public class TesteConversaoLongStringNovo 
        {
            ...
            {
                Nullable<long> numero = new Nullable<long>();
                string format = VtrConvert.DEFAULT_INTEGER_FORMAT;
                IFormatProvider culture = VtrConvert.DEFAULT_CULTURE_INFO;
                string expected = string.Empty;
                string actual;
                actual = VtrConvert.ToString(numero, format, culture);
        ...
        public class TesteNullObjectToBoolNovo
        {
            ...
            public void ToBoolWithCultureTest()
            {
                ...
                bool expected = false;
                bool actual;
                actual = VtrConvert.ToBool(obj, culture);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void ToNullableBoolWithCultureTest()
            {
                ...
                actual = VtrConvert.ToNullableBool(obj);
                Assert.AreEqual(expected, actual);
            }
            ...
            public void ToNullableBoolWithoutCultureTest()
            {
                ...
                Nullable<bool> expected = new Nullable<bool>();
                Nullable<bool> actual;
                actual = VtrConvert.ToNullableBool(obj, culture);
                Assert.AreEqual(expected, actual);
            }
        ...
        public class TesteConversaoToDatetimeNovo
        {
            ...
            public void NullToDateTimeTest()
            {
                ...
                DateTime actual;
                actual = VtrConvert.ToDateTime(obj);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToDateTimeCultureTest()
            {
                ...
                DateTime expected = DateTime.MinValue;
                DateTime actual;
                actual = VtrConvert.ToDateTime(obj, culture);
                Assert.AreEqual(expected, actual);
            ...
            public void ToNullableDateTimeTest()
            {
                ...
                DateTime? actual;
                actual = VtrConvert.ToNullableDateTime(obj);
                Assert.AreEqual(expected, actual);
            ...
            public void ToNullableDateTimeCultureTest()
            {
                ...
                DateTime? expected = null;
                DateTime? actual;
                actual = VtrConvert.ToNullableDateTime(obj, culture);
                Assert.AreEqual(expected, actual);
        ...
        public class ObjectToDoubleNovo
        {
            ...
            public void NullToDoubleTest()
            {
                ...
                double expected = 0F;
                double actual;
                actual = VtrConvert.ToDouble(obj);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToDoubleCultureTest()
            {
                ...
                double expected = 0F;
                double actual;
                actual = VtrConvert.ToDouble(obj, culture);
                Assert.AreEqual(expected, actual);
            ...
            {
                object obj = null;
                NumberStyles style = VtrConvert.DEFAULT_FLOAT_STYLE;
                CultureInfo culture = VtrConvert.DEFAULT_CULTURE_INFO;
                double expected = 0F;
                double actual;
                actual = VtrConvert.ToDouble(obj, style, culture);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToDoubleStyleTest()
            {
                ...
                double expected = 0F;
                double actual;
                actual = VtrConvert.ToDouble(obj, style);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToNullableDoubleTest()
            {
                ...
                double? actual;
                actual = VtrConvert.ToNullableDouble(obj);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToNullableDoubleCultureTest()
            {
                ...
                double? expected = null;
                double? actual;
                actual = VtrConvert.ToNullableDouble(obj, culture);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToNullableDoubleStyleCultureTest()
            {
                ...
                double? expected = null;
                double? actual;
                actual = VtrConvert.ToNullableDouble(obj, style, culture);
                Assert.AreEqual(expected, actual);
            ...
            public void NullToNullableDoubleStyleTest()
            {
                ...
                double? expected = null;
                double? actual;
                actual = VtrConvert.ToNullableDouble(obj, style);
                Assert.AreEqual(expected, actual);
        ...
        public void TrimNullTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = VtrConvert.TrimNull(obj);
            Assert.AreEqual(expected, actual);
        ...
        {
            CultureInfo actual;
            actual = VtrConvert.DEFAULT_CULTURE_INFO;
        ...
        {
            string actual;
            actual = VtrConvert.DEFAULT_DATETIME_FORMAT;
        ...
        {
            string actual;
            actual = VtrConvert.DEFAULT_DATE_FORMAT;
        ...
        {
            NumberStyles actual;
            actual = VtrConvert.DEFAULT_FLOAT_STYLE;
        ...
        {
            string actual;
            actual = VtrConvert.DEFAULT_INTEGER_FORMAT;
        ...
        {
            NumberStyles actual;
            actual = VtrConvert.DEFAULT_INTEGER_STYLE;
        ...
        public class OutrosTestes
        {
            ...
            public void DoubleSemParametrosDeveriaVirPadrao()
            {
                ...
                string actual = VtrConvert.ToString(teste);
            ...
            public void DoubleComParametro_R_DeveriaVirComDecimaisOpcionais()
            {
                ...
                string actual = VtrConvert.ToString(teste, "R", VtrConvert.DEFAULT_CULTURE_INFO);
                Assert.AreEqual(esperado, actual);
            }
            ...
            public void DoubleComApenasParametro_R_DeveriaVirComDecimaisOpcionais()
            {
                ...
                string actual = VtrConvert.ToString(teste, "R");
                Assert.AreEqual(esperado, actual);
            }
        }
