...
namespace VtrFramework.WebForms.Extensions
{
    ...
    public static class VtrWebExtensions
    {
        ...
        private static VtrHierarchicalList _getRoots(VtrHierarchicalList lista)
        {
        ...
        private static void _scanTrees(this DropDownList ddl, VtrHierarchicalList lista, bool useValorpath, VtrFormatacaoDeArvore formato, int nivel = 0, bool primeiroVazio = true)
        {
            ...
            foreach (var c in lista)
            {
                ...
                if (c.HasChildren)
                {
                    _scanTrees(ddl, (VtrHierarchicalList)c.GetChildren(), useValorpath, formato, nivel + 1, false);
                }
            }
