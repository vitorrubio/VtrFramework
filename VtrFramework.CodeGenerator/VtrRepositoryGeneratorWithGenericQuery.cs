...
namespace VtrFramework.CodeGenerator
{
    ...
    /// 
    /// </summary>
    public class VtrRepositoryGeneratorWithGenericQuery : IVtrGenerator, IVtrRepositoryGenerator
    {
        ...
        public VtrRepositoryGeneratorWithGenericQuery(VtrTable table, string baseNamespace, string basePath)
        {
            if (table == null)
...
{2}
        ...
        private void BuildGetById(StringBuilder sb)
        {
            ...
            sb.Append(string.Format("\t\t\tvar dados = _db.Query<{0}>(sql, new VtrParameter(\"@Id\", id));\r\n", this.Tabela.Nome));
            sb.Append("\t\t\tif((dados!=null)&&(dados.Count() > 0))\r\n");
            sb.Append("\t\t\t{\r\n");
            sb.Append("\t\t\t\tresult = dados.FirstOrDefault();\r\n");
            sb.Append("\t\t\t}\r\n");
        ...
        private void BuildGetAll(StringBuilder sb)
        {
            ...
            sb.Append(string.Format("\t\t\tvar dados = _db.Query<{0}>(sql);\r\n", this.Tabela.Nome));
            sb.Append("\t\t\tif((dados!=null)&&(dados.Count() > 0))\r\n");
            sb.Append("\t\t\t{\r\n");
            sb.Append("\t\t\t\tresult.AddRange( dados);\r\n");
            sb.Append("\t\t\t}\r\n");
        ...
        private void BuildGetByForeignKey(StringBuilder sb, string PropertyName)
        {
            ...
            sb.Append(string.Format("\t\t\tvar dados = _db.Query<{1}>(sql, new VtrParameter(\"@{0}\", a{0}));\r\n", PropertyName, this.Tabela.Nome));
            sb.Append("\t\t\tif((dados!=null)&&(dados.Count() > 0))\r\n");
            sb.Append("\t\t\t{\r\n");
            sb.Append("\t\t\t\tresult.AddRange( dados);\r\n");
            sb.Append("\t\t\t}\r\n");
        ...
        private void BuildGetBetweenDates(StringBuilder sb, string PropertyName)
        {
            ...
            sb.Append(string.Format("\t\t\tvar dados = _db.Query<{0}>(sql, new VtrParameter(\"@DtIni\", dtIni), new VtrParameter(\"@DtFin\", dtFin));\r\n", this.Tabela.Nome));
            sb.Append("\t\t\tif((dados!=null)&&(dados.Count() > 0))\r\n");
            sb.Append("\t\t\t{\r\n");
            sb.Append("\t\t\t\tresult.AddRange( dados);\r\n");
            sb.Append("\t\t\t}\r\n");
